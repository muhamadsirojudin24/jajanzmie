...
export const Page = () => {
    return (
        <main className="bg-gradient-to-b from-red-700 via-red-800 to-red-900 h-max flex flex-col items-center p-5">
            ...
            <Button text="Official | Sosial Media"/>
            <section className="flex gap-5">
                <LinkSosmed href="https://www.instagram.com/jajanzmie" src="instagram.png" alt="instagram" width={50}/>
                <LinkSosmed href="#" src="tik-tok.png" alt="tik-tok" width={50}/>
                <LinkSosmed href="https://wa.me/6283187611782" src="whatsapp.png" alt="whatsapp" width={50}/>
            </section>
